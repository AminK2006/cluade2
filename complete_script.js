// Initial messages data - you can customize these
let messages = [
    {
...
/**
 * Update contact information and notification count
 */
...
function renderMessages() {
    ...
    messages.forEach((message, index) => {
        ...
        // Add click event for editing (removed - now only triple tap works)
        // messageDiv.addEventListener('click', (e) => {
        //     if (!messageDiv.classList.contains('show-timestamp')) {
        //         editMessage(index);
        //     }
        // });
...
/**
 * Handle touch start for swipe interactions
...
/**
 * Handle touch move for swipe interactions
 * @param {TouchEvent} e - Touch event
 */
...
/**
 * Handle touch end for swipe interactions
 * @param {TouchEvent} e - Touch event
 */
...
/**
 * Show the edit panel for adding new messages
 */
...
function showConfigMode() {
    ...
    // Hide message fields, show config fields
...
/**
 * Delete the currently edited message
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Triple tap detection for edit panel
